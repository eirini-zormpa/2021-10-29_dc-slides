...
> Whenever we visulise data, we take data values and convert them in a systematic and logical way into the visual elements that make up the final graphic. [...] The key insight is the following: All data visualisations map data values into quantifiable featrures of the resulting graphic. We refer to these features as **aesthetics**.
...
## Find the blue dot `r emo::ji("sparkles")`
...
## Find the blue dot `r emo::ji("rocket")`
